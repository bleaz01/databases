<nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
		...
		<div class="collapse navbar-collapse" id="navbarsExampleDefault">
            ...
            <form class="form-inline my-2 my-lg-0 " action= "" method="POST">
                <input class="form-control mr-sm-2	include "assets/include/nav_in.php";
 " type="text" placeholder="Username" aria-label="Username"
			...
			<ul class="navbar-nav mr-right">
                <li class="nav-item">
                    <a class="nav-link btn btn-outline-success my-2 my-sm-0 <?= $logoutNone ?>" href="profile.php">
                </li>
                <form class="form-inline my-2 my-lg-0" action="" method="POST">
                    <button class="btn btn-outline-success my-2 my-sm-0 <?= $logoutNone ?>"name="Logout"  type="submit">Logout</button>
				</form>
				<a class="btn btn-outline-success my-2 my-sm-0  "  type="submit" href="register.php">Register</a>
            </ul>
